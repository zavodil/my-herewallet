import type { InjectedWallet, NetworkId, WalletBehaviourFactory } from "@near-wallet-selector/core";
import { NearSnap, NearSnapAccount } from "@near-snap/sdk";

export const snap = new NearSnap();

export const initNearSnap: WalletBehaviourFactory<InjectedWallet> = async (config) => {
  ...
  return {
    ...
    async signMessage(data: any) {
      ...
      return await account.signMessage(data);
    },
